...
- 代码：
  - [src/node.js:149](/Users/vector/.openclaw/workspace/openclaw-gep/src/node.js:149)
  - [src/index.js:623](/Users/vector/.openclaw/workspace/openclaw-gep/src/index.js:623)
  - [src/index.js:696](/Users/vector/.openclaw/workspace/openclaw-gep/src/index.js:696)

2. 账本写入改为仅 Leader 执行
- 原先 `isGenesisNode` 直接 `appendAsMaster`，现在只有 `isLedgerLeader()` 才写账本并广播 `tx_log`
- 其他节点（含路由主）只转发 `tx` 并同步 `tx_log`
- 代码：
  - [src/index.js:397](/Users/vector/.openclaw/workspace/openclaw-gep/src/index.js:397)
  - [src/index.js:770](/Users/vector/.openclaw/workspace/openclaw-gep/src/index.js:770)
  - [src/index.js:162](/Users/vector/.openclaw/workspace/openclaw-gep/src/index.js:162)
  - [src/index.js:191](/Users/vector/.openclaw/workspace/openclaw-gep/src/index.js:191)

3. 主节点互联路由 + 发现保持
- 你上次要的 `route_sync` 保留，并继续自动扩展主节点连接
- 代码：
  - [src/node.js:143](/Users/vector/.openclaw/workspace/openclaw-gep/src/node.js:143)
  - [src/node.js:529](/Users/vector/.openclaw/workspace/openclaw-gep/src/node.js:529)

4. 创世账本引导改为显式控制
- 新增 `bootstrapLedger`（CLI: `--bootstrap-ledger`），仅首个创世节点需要
- 其他路由主不再默认自行创世，避免各自铸币导致分叉
- 代码：
  - [src/index.js:27](/Users/vector/.openclaw/workspace/openclaw-gep/src/index.js:27)
  - [src/index.js:97](/Users/vector/.openclaw/workspace/openclaw-gep/src/index.js:97)
  - [src/cli.js:105](/Users/vector/.openclaw/workspace/openclaw-gep/src/cli.js:105)
  - [src/cli.js:192](/Users/vector/.openclaw/workspace/openclaw-gep/src/cli.js:192)

5. 状态增加 Leader 信息
- `getStats()` 增加 `leaderId / isLedgerLeader / term`
- 代码：
  - [src/index.js:983](/Users/vector/.openclaw/workspace/openclaw-gep/src/index.js:983)
...
- 关键实现：
  - [src/index.js](/Users/vector/.openclaw/workspace/openclaw-gep/src/index.js) `startRaftConsensus/startElection/becomeLeader/advanceCommitIndex/applyCommittedLogEntries/proposeTx`

2. 日志冲突回滚
- follower 处理 `AppendEntries` 时校验 `prevLogIndex/prevLogTerm`。
- 冲突时会截断本地未提交冲突段并回退，等待 leader 重发，保证日志最终一致。
- 关键实现：
  - [src/index.js](/Users/vector/.openclaw/workspace/openclaw-gep/src/index.js) `onRaftAppendEntries/onRaftAppendEntriesResponse`
...
- 关键实现：
  - [src/index.js](/Users/vector/.openclaw/workspace/openclaw-gep/src/index.js) `loadConsensusState/persistConsensusState`
...
- 关键实现：
  - [src/node.js](/Users/vector/.openclaw/workspace/openclaw-gep/src/node.js)

5. 固定投票集合支持（用于“严格多数”）
- 新增 CLI 参数：`--consensus-voters node_a,node_b,node_c`
- 不配置时会回退为动态发现（不建议生产）。
- 关键实现：
  - [src/cli.js](/Users/vector/.openclaw/workspace/openclaw-gep/src/cli.js)
  - [src/index.js](/Users/vector/.openclaw/workspace/openclaw-gep/src/index.js) `consensusVoterIds/getVoterNodeIds/getMajorityCount`
...
- 代码：  
  - [src/index.js:116](/Users/vector/.openclaw/workspace/openclaw-gep/src/index.js:116)  
  - [src/index.js:138](/Users/vector/.openclaw/workspace/openclaw-gep/src/index.js:138)  
  - [src/index.js:771](/Users/vector/.openclaw/workspace/openclaw-gep/src/index.js:771)  
  - [src/index.js:826](/Users/vector/.openclaw/workspace/openclaw-gep/src/index.js:826)  
  - [src/index.js:852](/Users/vector/.openclaw/workspace/openclaw-gep/src/index.js:852)  
  - [src/index.js:1430](/Users/vector/.openclaw/workspace/openclaw-gep/src/index.js:1430)
...
- 代码：  
  - [src/index.js:746](/Users/vector/.openclaw/workspace/openclaw-gep/src/index.js:746)  
  - [src/index.js:971](/Users/vector/.openclaw/workspace/openclaw-gep/src/index.js:971)  
  - [src/index.js:997](/Users/vector/.openclaw/workspace/openclaw-gep/src/index.js:997)  
  - [src/index.js:1006](/Users/vector/.openclaw/workspace/openclaw-gep/src/index.js:1006)  
  - [src/index.js:1016](/Users/vector/.openclaw/workspace/openclaw-gep/src/index.js:1016)  
  - [src/index.js:1024](/Users/vector/.openclaw/workspace/openclaw-gep/src/index.js:1024)

3. 非 leader 的交易中继优化
- 优先直发当前 leader，失败再退回全网广播，减少无效 P2P 扩散。
- 代码：  
  - [src/index.js:341](/Users/vector/.openclaw/workspace/openclaw-gep/src/index.js:341)
